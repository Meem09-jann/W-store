...
const PageLogin = () => {
  ...
  async function handleLogin(e) {
    ...
    //return router.push('http://vendor.18mall.shop');

    return router.push('http://vendor.18mall.shop/live-of-user/' + response.output.profile.userId);
      ...
      <div className="container mb-24 lg:mb-32">
        ...
        <div className="max-w-md mx-auto space-y-6">
          ...
          <span className="block text-center text-neutral-700 dark:text-neutral-300">
            ...
            <Link className="text-green-600" href={{ pathname: '/vendor-signup' }}>
          ...
          <span className="block text-center text-neutral-700 dark:text-neutral-300">
            ...
            <Link className="text-green-600" href={{ pathname: '/user-forgetpwd', query: { role: 'VENDOR'} }}>
