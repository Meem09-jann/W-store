...
import AffiliateTable from "@/components/DataTable/AffiliateTable";
...
const AccountSavelists = () => {
  ...
  useEffect(() => {
    getBonusComission(cookies.jwtToken, cookies?.profile?.userId)
      .then((data) => {
        // setBonus(data.userBonuses?.[0]?.affiliate || 0)
        setBonus(data.userBonuses)
      });
