...
async function getStoreProduct(jwtToken: string,owner_id: string,limit: number = 100, offset: number = 0,  sortBy: string = 'id', sortType: string = 'desc',role: string = 'USER') {
...
const PageCollection = ({ params }) => {
  ...
  useEffect(() => {
    ...
    getStoreProduct(cookies.jwtToken,params.ownerId,)
      .then((data) => {
