...
export default function AvatarDropdown() {
  ...
  const [photoURL, setPhotoURL] = useState(`${process.env.NEXT_PUBLIC_IMAGE_BASE}`+`web/assets/slider/37KZ7raEY2_No-Image-Placeholder.svg.png`);
                ...
                <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className={`wil-avatar relative flex-shrink-0 inline-flex items-center justify-center text-neutral-100 uppercase font-semibold shadow-inner rounded-full h-6 w-6 text-sm ring-1 ring-white dark:ring-neutral-900`}>
                      <Image
                        //loader={myLoader}
                        className={`absolute inset-0 w-full h-full object-cover rounded-full`}
                        src={ (!photoURL || photoURL=="")?process.env.NEXT_PUBLIC_IMAGE_BASE+"web/assets/product/R0iNX0dTtE_default1.jpeg" : process.env.NEXT_PUBLIC_IMAGE_BASE+photoURL}
                        alt={fullname}
                        width={500}
                        height={500}
                    />
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium ">{"注文履歴"}</p>
                      </div>
                    </Link>
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium ">{"お届け先の住所"}</p>
                      </div>
                    </Link> 
                    ...
                    <div className="flex items-center justify-between p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <p className="text-sm font-medium ">{"ダークテーマ"}</p>
                        </div>
                      </div>
                      <SwitchDarkMode2 />
                    </div>
