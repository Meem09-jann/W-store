...
export default function AvatarDropdown2() {
  return (
                      ...
                      <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                        ...
                        >
                          ...
                          <path
                            ...
                            strokeLinejoin="round"
                          /> */}
                          <path d="M24 28H6c-.6 0-1-.4-1-1v-2c0-5.5 4.5-10 10-10s10 4.5 10 10v2c0 .6-.4 1-1 1zM7 26h16v-1c0-4.4-3.6-8-8-8s-8 3.6-8 8v1zm8-12c-2.8 0-5-2.2-5-5s2.2-5 5-5 5 2.2 5 5-2.2 5-5 5zm0-8c-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3-1.3-3-3-3zm9 4c-.3 0-.5-.1-.7-.3l-2-2c-.4-.4-.4-1 0-1.4.4-.4 1-.4 1.4 0L24 7.6l2.3-2.3c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-3 3c-.2.2-.4.3-.7.3z"></path>
                        </svg>
