...
const ModalCommingSoon: FC<ModalProps> = ({
  data,
  onclick,
  show,
  onCloseModal,
            ...
            <div className="inline-block py-8 h-auto w-auto min-w-[300px] max-w-5xl">
              <div className="inline-flex pb-2 flex-col w-full text-left align-middle transition-all transform overflow-hidden rounded-2xl bg-white dark:bg-neutral-900 dark:border dark:border-neutral-700 dark:text-neutral-100 shadow-xl h-full">
                ...
                <div className="px-8 my-5 flex justify-center flex-wrap">
                  ...
                  <button className="bg-sky-500 hover:bg-blue-700 text-white font-bold py-2 px-4 ml-3 rounded" type="submit" onClick={onCloseModal}>いいえ</button>
                </div>
