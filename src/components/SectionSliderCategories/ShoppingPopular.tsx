...
const ShoppingPopular = ({
  heading = "Shopping Live Popular",
  subHeading = "",
  className = "",
  itemClassName = "",
  data
          ...
          <ul className="glide__slides">
            {data.map((item, index) => (
              <li key={index} className={`glide__slide ${itemClassName}`}>
                ...
                <CardCategory2
                  id={item.id}
                  featuredImage={item.bannerImage ? `${process.env.NEXT_PUBLIC_IMAGE_BASE}`+item.bannerImage : defaultimg}
...
export default ShoppingPopular;
