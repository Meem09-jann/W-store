...
const SectionHero2 = ({ data, className = "" }) => {
  // =================
  ...
  const renderItem = (index: number) => {
    ...
    return (
      ...
      >
        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44 main-slide-item">
          <div
            className={`relative z-[1] w-full max-w-3xl space-y-8 sm:space-y-14 nc-SectionHero2Item__left`}
          >
            <div className="space-y-5 sm:space-y-6 slider-content-container">
