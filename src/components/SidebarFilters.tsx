...
//
const SidebarFilters = ({faqCategory, onCategorySelected}) => {
  //
  ...
  const renderTabsCategories = () => {
    return (
      <div className="relative flex flex-col pb-8 space-y-4">
        <h3 className="font-semibold mb-2.5">Faq Categories</h3>
        <ul className="max-w-xs flex flex-col divide-y divide-gray-200 dark:divide-gray-700">
        <button onClick={()=>onCategorySelected(0)} className="inline-flex items-center gap-x-2 py-3 text-sm font-medium text-gray-500 dark:text-white hover:text-gray-800 ">
            {"All"}
          </button>
        {(faqCategory as any)?.map((item) => (
          ...
          <button onClick={()=>onCategorySelected(item.id)} className="inline-flex items-center gap-x-2 py-3 text-sm font-medium text-gray-500 dark:text-white hover:text-gray-800 ">
            {item.title}
          </button>
