...
const WishListProductCard = ({
  ...
  cover_image = cover_image ? process.env.NEXT_PUBLIC_IMAGE_BASE + cover_image : defaultimg;
        ...
        <div className="ml-4 flex flex-1 flex-col">
          <div>
            <div className="flex justify-between ">
              ...
              <Prices price={dis_price} currency={currency} className="mt-0.5" />
            </div>
          </div>
  ...
  return (
    <>
      ...
      >
        <Link href={"/productDetails/" + id + "/" + productId} className="absolute inset-0"></Link>

        <div className="relative flex-shrink-0 bg-slate-50 dark:bg-slate-300 rounded-3xl overflow-hidden z-1 group">
          <Link href={"/productDetails/" + id + "/" + productId} className="block">
            <NcImage
          ...
          <ProductStatus status={startData} />
          {/* <LikeButton liked={likedata} className="absolute top-3 right-3 z-10" />
        ...
        <div className="space-y-4 px-2.5 pt-5 pb-2.5">
          ...
          <div className="flex flex-col justify-start items-start text-[13px]">
            <Prices price={dis_price} currency={currency} />
            <div className="flex">
              <DisPrices price={price} currency={currency} />
              <div className="flex items-center mb-0.5 text-red-500">
                {percentage || 0}%
              </div>
            </div>

            {/* <p className="text-blue-600/0">{price}</p> */}
